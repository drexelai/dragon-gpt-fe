...
export default function EventEmbed({ event }: { event: CalendarEvent }) {
	...
	return (
		<div
			className={cn("flex flex-row py-3 px-1 gap-2 rounded-xl bg-opacity-70 shadow-md hover:cursor-pointer", event.color)}
		...
		>
			...
			<div className="flex flex-col w-full">
				<p className="text-base font-medium max-w-64">{event.title}</p>
