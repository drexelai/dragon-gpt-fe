...
export default function ChatInput({
	...
	return (
		<div className="z-10 items-center justify-center flex flex-row gap-2 w-[-webkit-fill-available]">
			<div className="flex flex-row items-center px-1 w-[-webkit-fill-available] max-w-xl border-solid border rounded-3xl shadow-spread dark:shadow-none focus-within:ring-1 focus-within:ring-neutral-500 bg-gray-200 dark:bg-neutral-700 backdrop-blur-md backdrop-filter">
				<div
				...
				<Button
					...
					variant="ghost"
				>
					<Mic className="hover:scale-90 transition-all" />
